<?php include "C:xampp/htdocs/Backendphp/feedback/include/header.php"; ?>

<?php
/*<?php include "C:xampp/htdocs/Backendphp/feedback/config/database.php"; ?>*/
...
?>
    ...
    <img src="feedback/img/phplogo.png" class="w-25 mb-3" alt="phplogo">
    <h2>Feedback</h2>
    <?php echo isset($name) ? $name : ''; ?>
    <p class="lead text-center">Leave feedback for Manuel Taya</p>
...
<?php include "C:xampp/htdocs/Backendphp/feedback/include/footer.php"; ?>